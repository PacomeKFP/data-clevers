          ...
          child: Column(
            children: [
              Container(
                ...
                decoration: const BoxDecoration(color: Color.fromARGB(255, 1, 102, 145)),
                child: Column(
                  children: [
                    Row(
                            ...
                            onTap: () => Navigator.pushNamed(
                                ...
                                arguments: {
                                  ...
                                  'course': {
                                    ...
                                    'teacher' : 'Mr. Ghislain Poum',
                                    'description': "Machine Learning is the field of data science that ...."
                                  }
                                }),
                            child: Text(
                              'Begin',
